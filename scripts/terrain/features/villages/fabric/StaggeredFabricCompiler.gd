...
static func append_specs(program: SettlementFabricProgram,
	...
	for recipe_id: StringName in [&"room.base.rock", &"room.base.rock.closed",
			&"room.upper.blue", &"room.upper.orange", &"room.upper.stone",
			&"room.upper.blue.b", &"room.upper.orange.b", &"room.upper.stone.b",
			&"room.upper.address.blue", &"room.upper.address.orange",
			&"room.upper.address.stone", &"room.upper.address.blue.b",
			&"room.upper.address.orange.b", &"room.upper.address.stone.b",
			...
			&"room.tower.upper.orange.b", &"room.tower.upper.stone.b",
			...
			&"room.slim.upper.orange.b", &"room.slim.upper.stone.b",
...
static func _proposal_facade_family(proposal: Dictionary,
	...
	assert(theme.is_empty() or theme in [&"blue", &"orange", &"stone"])
